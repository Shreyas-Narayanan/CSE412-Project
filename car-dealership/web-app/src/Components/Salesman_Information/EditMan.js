...
export default function EditMan({m}) {
    ...
    const updateDescription = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5000/salesman/${m.salesman_id}`, {
                method: "PUT",
        ...
        <Fragment>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Editing Salesman {m.salesman_id}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div>
                        <h6>First Name</h6>
